$( document ).ready(function() {
	...
	// let Decor = function(){
	// 	let container = document.querySelector(".header-main__contacts")
	// 	let width = $(container).width() + 35;
	// 	$('head').append(`<style>.container:after{width: ${ width }px !important;}</style>`);
